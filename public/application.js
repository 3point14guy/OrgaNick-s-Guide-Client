...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.signIn(data).then(ui.signInSuccess).then(getAllVegetables).then(getGarden).then(getAllPests).catch(ui.signInFailure);
	};
	...
	var addVegetable = function addVegetable(event) {
	  event.preventDefault();
	  var data = { garden: { 'vegetable_id': $(event.target).attr('data-id') } };
	  api.addAVegetable(data).then(ui.addVegetableSuccess).then(function (data) {
	    getGarden();
	    $('#delete-vegetable').on('submit', deleteVegetable);
	  }).catch(ui.addVegetableFailure);
	};

	var deleteVegetable = function deleteVegetable(event) {
	  event.preventDefault();
	  var data = $(event.target).attr('data-id');
	  api.deleteAVegetable(data).then(function (data) {
	    getGarden();
	  }).then(ui.deleteVegetableSuccess).catch(ui.deleteVegetableFailure);
	};
	...
	var updateComments = function updateComments(event) {
	  event.preventDefault();
	  var textAreaVal = $(event.delegateTarget).parents('li').siblings('.theseComments').children('textarea').val();
	  var gardenData = { garden: { 'id': $(event.target).attr('data-id'), 'comments': textAreaVal } };
	  api.updateAComment(gardenData).then(function (data) {
	    getGarden();
	  }).then(ui.updateCommentsSuccess).catch(ui.updateCommentsFailure);
	};

	// commented out event default that was throwing error
	// handler added here so that it is available after resource data loads
	var getAllVegetables = function getAllVegetables() {
	  // event.preventDefault()
	  api.requestAllVegetables().then(ui.allVegetablesSuccess).then(function (data) {
	    $('.add-veggie-button').on('click', addVegetable);
	  }).catch(ui.allVegetableFailure);
	};

	var getGarden = function getGarden(data) {
	  api.requestGarden(data).then(ui.getGardenSuccess).then(function (data) {
	    $('.delete-veggie-button').on('click', deleteVegetable);
	    $('.update-comments-button').on('click', updateComments);
	  }).catch(ui.getGardenFailure);
	};

	var getAllPests = function getAllPests() {
	  api.requestPests().then(ui.allPestsSuccess).catch(ui.allPestsFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// helps to correct bad syntax and avoid misnaming or unused variables
	'use strict';
	...
	var requestAllVegetables = function requestAllVegetables(data) {
	  return $.ajax({
	...
	var addAVegetable = function addAVegetable(data) {
	  return $.ajax({
	...
	var deleteAVegetable = function deleteAVegetable(data) {
	  return $.ajax({
	...
	var requestGarden = function requestGarden(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/gardens',
	    method: 'GET',
	    headers: {
	...
	var updateAComment = function updateAComment(data) {
	  return $.ajax({
	...
	var requestPests = function requestPests(data) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  logout: logout,
	  requestAllVegetables: requestAllVegetables,
	  requestGarden: requestGarden,
	  addAVegetable: addAVegetable,
	  deleteAVegetable: deleteAVegetable,
	  updateAComment: updateAComment,
	  requestPests: requestPests
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports) {
	...
	'use strict';
	// assigns global variable to be used across files

	var store = {};
	// exports this variable to be accessed by other files
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displayVegetablesTemplate = __webpack_require__(12);
	var displayGardenTemplate = __webpack_require__(32);
	var displayPestsTemplate = __webpack_require__(33);
	...
	var allVegetablesSuccess = function allVegetablesSuccess(data) {
	  store.vegetable = data.vegetable;
	  // assigns data from handlebars file
	  var displayVegetablesHTML = displayVegetablesTemplate({ vegetables: data.vegetables });
	...
	var allVegetablesFailure = function allVegetablesFailure(error) {
	  $('.instructions').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};

	var deleteVegetableSuccess = function deleteVegetableSuccess() {
	  $('.instructions').text('Vegetable successfully deleted.');
	};
	var deleteVegetableFailure = function deleteVegetableFailure(error) {
	  $('.delete-vegetable').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};

	var addVegetableSuccess = function addVegetableSuccess(data) {
	  var displayGardenHTML = displayGardenTemplate({ gardens: data.gardens });
	  $('.instructions').text('Vegetable successfully added.');
	  $('.your-list').prepend(displayGardenHTML);
	  $('.your-list').show();
	};
	var addVegetableFailure = function addVegetableFailure(error) {
	  $('.instructions').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};

	var updateCommentsSuccess = function updateCommentsSuccess(data) {
	  $('.instructions').text('Your comment update was successful.');
	};
	var updateCommentsFailure = function updateCommentsFailure(error) {
	  $('.update-a-comment').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};

	var getGardenSuccess = function getGardenSuccess(data) {
	  var displayGardenHTML = displayGardenTemplate({ gardens: data.gardens });
	  $('.your-list').empty();
	  $('.your-list').prepend(displayGardenHTML);
	  $('.your-list').show();
	};
	var getGardenFailure = function getGardenFailure(error) {
	  $('.instructions').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};

	var allPestsSuccess = function allPestsSuccess(data) {
	  var displayPestsHTML = displayPestsTemplate({ pests: data.pests });
	  $('.pest-list').empty();
	  $('.pest-list').append(displayPestsHTML);
	  $('.pest-list').show();
	};

	var allPestsFailure = function allPestsFailure(error) {
	  $('.instructions').text('Oops, something went wrong.', error).fadeIn('fast').delay(2000).fadeOut('slow');
	};
	...
	module.exports = {
	  ...
	  allVegetablesSuccess: allVegetablesSuccess,
	  allVegetablesFailure: allVegetablesFailure,
	  deleteVegetableSuccess: deleteVegetableSuccess,
	  deleteVegetableFailure: deleteVegetableFailure,
	  addVegetableSuccess: addVegetableSuccess,
	  addVegetableFailure: addVegetableFailure,
	  updateCommentsSuccess: updateCommentsSuccess,
	  updateCommentsFailure: updateCommentsFailure,
	  getGardenSuccess: getGardenSuccess,
	  getGardenFailure: getGardenFailure,
	  allPestsFailure: allPestsFailure,
	  allPestsSuccess: allPestsSuccess
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div>\n    <ul class=\"list\" data-id=\""
	    ...
	    + "></li>\n      <li><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"add-veggie-button dropbtn\"> Add </button></li>\n      <br/>\n    </ul>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.vegetables : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "<!-- #each will follow the code inside it for each value in the gardens table\nthis data will be displayed in an unodered list\ncan access data in the vegetables table through chaining: vegetable.name\ndata- tag specifies what values will be passsed in ajax requests\nclass names on buttons allow for unique commands based on which button is selected -->\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.user : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "    <div>\n      <ul class=\"list\">\n      <li><h3>"
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[1][0]) != null ? stack1.vegetable : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h3></li>\n      <li><img class=\"thumbnail\" src="
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[1][0]) != null ? stack1.vegetable : stack1)) != null ? stack1.image : stack1), depth0))
	    + "></li>\n      <br/>\n      <li class=\"theseComments\"><textarea class=\"commentsData\" rows=\"4\" cols=\"20\" data-comments=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.comments : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.comments : stack1), depth0))
	    + "</textarea></li>\n      <br/>\n      <li><button  data-target=\"register-comments\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-comments-button dropbtn\"> Edit Comments </button></li>\n      <li><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"delete-veggie-button dropbtn\"> Delete </button></li>\n      </ul>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.gardens : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n\n<!-- #each will follow the code inside it for each value in the gardens table\n#if will only deiplay when the current user is logged in\nthis data will be displayed in an unodered list\ngardens is a join table, can access data in the vegetables table through chaining: garden.vegetable.name\nclass theseComments is there to help target the user entered comments\ngardens.comments is a new column in the gardens table\ndata- tag specifies what values will be passsed in ajax requests\nclass names on buttons allow for unique commands based on which button is selected -->\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pests : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n<!-- #each will follow the code inside it for each value in the gardens table\nthis data will be displayed in an unodered list\ncan access data in the pests table through chaining: pest.name-->\n";
	},"useData":true,"useBlockParams":true});
